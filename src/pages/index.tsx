...
const Home: FC = () => {
	...
	<div className='max-h-[55vh] flex flex-col lg:flex-row pt-28 w-full justify-center ' >
			...
			<div>
				<h1 className='mb-64 mt-28 ml-0 lg:mt-0 pl-6 lg:pl-10 justify-center text-2xl lg:text-5xl text-gray-400 bg-blue font-Mono uppercase max-w-[22em] lg:max-w-[17em] mr-5  transition-all' style={{ lineHeight: '1.3' }}> 

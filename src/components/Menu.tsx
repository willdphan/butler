...
const Menu = () => {
	return (
		<div className='flex flex-col justify-center lg:flex-row w-full lg:min-h-[45vh] text-black text-4xl font-Mono uppercase  max-w-screen-2xl	'>
				...
				<h1 className="pl-10 pt-5 h-[90%] flex items-center group-hover:bg-black group-hover:hidden text-3xl lg:text-5xl rounded-tr-3xl mx-1 font-light">Connect</h1>
  ...
  <p className="hidden lg:block bg-gray-200 text-lg h-[10%] flex pl-10 group-hover:bg-black group-hover:text-white items-center pt-1 mx-1 mb-1 transition-all ">Email</p>
</div>
